...
def generate_phase4_master():
    ...
    # Subplot 1: Scalability: Needleman-Wunsch (Runtime vs Input Size)
    nw_df = df[df['algorithm'] == 'Needleman-Wunsch']
    platforms = ['Darwin', 'Linux', 'Windows']
    colors = {'Darwin': '#1f77b4', 'Linux': '#2ca02c', 'Windows': '#d62728'}
    
    # Subplot 1: Backend Comparison at Max Scale
    ...
    # Subplot 2: Forward 5000: Cross-Platform Performance
    ...
    # Subplot 3: Graph-DP 10000: Efficiency at Scale
